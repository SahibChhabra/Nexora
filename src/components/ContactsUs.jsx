...
const ContactsUs = () => {
    ...
    formData.append("access_key", "76a71c62-0df3-47e5-8da8-f68ab5af4414");
  ...
  return (
    <div id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40
       pt-30 text-gray-700 dark:text-white '>
         <Title title='Reach out to us' desc='From strategy to execution, we craft digital solutions 
                ...
                <div className='flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600'>
                  ...
                  <div className='sm:col-span-2'>
                   ...
                   <textarea name='message' rows={8} placeholder='Enter your message' className='
                      w-full p-3 resize-none text-sm outline-none rounded-lg border border-gray-300
                      dark:border-gray-600' required/>
                  </div>

                  <button type="submit" className='w-max flex gap-2 bg-primary text-white text-sm 
                  px-10 py-3 rounded-full cursor-pointer hover:scale-103 transition-all'>Submit  
